...
var _cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs = _interopRequireDefault(__webpack_require__(34051));
...
var CachedComponent;
function _initNext() {
    _initNext = _asyncToGenerator(_cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.mark(function _callee() {
        ...
        return _cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.wrap(function _callee$(_ctx) {
...
function _render() {
    _render = _asyncToGenerator(_cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.mark(function _callee(renderingProps) {
        var renderErr;
        return _cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
   ...
   */ key: "replace",
        ...
        },
        {
            ...
            value: function change(method, url, as, options, forcedScroll) {
                var _this = this;
                return _asyncToGenerator(_cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.mark(function _callee() {
...
function _loadGetInitialProps() {
    _loadGetInitialProps = _asyncToGenerator(_cUsersUserDesktopНоваяпапкаSolanaToolsNodeModulesNextDistCompiledRegeneratorRuntimeRuntimeJs.default.mark(function _callee(App, ctx) {
