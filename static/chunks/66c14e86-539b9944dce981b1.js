...
/* harmony export */   "RG": function() { return /* binding */ Keypair; },
/* harmony export */   "nh": function() { return /* binding */ PublicKey; },
/* harmony export */   "ze": function() { return /* binding */ SYSVAR_RENT_PUBKEY; },
/* harmony export */   "yc": function() { return /* binding */ SystemProgram; },
/* harmony export */   "YW": function() { return /* binding */ Transaction; },
/* harmony export */   "Sl": function() { return /* binding */ TransactionInstruction; },
/* harmony export */   "BV": function() { return /* binding */ sendAndConfirmTransaction; }
/* harmony export */ });
/* unused harmony exports Account, Authorized, BLOCKHASH_CACHE_TIMEOUT_MS, BPF_LOADER_DEPRECATED_PROGRAM_ID, BPF_LOADER_PROGRAM_ID, BpfLoader, COMPUTE_BUDGET_INSTRUCTION_LAYOUTS, ComputeBudgetInstruction, ComputeBudgetProgram, Connection, Ed25519Program, Enum, EpochSchedule, FeeCalculatorLayout, LAMPORTS_PER_SOL, Loader, Lockup, MAX_SEED_LENGTH, Message, NONCE_ACCOUNT_LENGTH, NonceAccount, PACKET_DATA_SIZE, SIGNATURE_LENGTH_IN_BYTES, SOLANA_SCHEMA, STAKE_CONFIG_ID, STAKE_INSTRUCTION_LAYOUTS, SYSTEM_INSTRUCTION_LAYOUTS, SYSVAR_CLOCK_PUBKEY, SYSVAR_EPOCH_SCHEDULE_PUBKEY, SYSVAR_INSTRUCTIONS_PUBKEY, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, SYSVAR_REWARDS_PUBKEY, SYSVAR_SLOT_HASHES_PUBKEY, SYSVAR_SLOT_HISTORY_PUBKEY, SYSVAR_STAKE_HISTORY_PUBKEY, Secp256k1Program, SendTransactionError, StakeAuthorizationLayout, StakeInstruction, StakeProgram, Struct, SystemInstruction, TransactionStatus, VALIDATOR_INFO_KEY, VOTE_PROGRAM_ID, ValidatorInfo, VoteAccount, VoteAuthorizationLayout, VoteInit, VoteInstruction, VoteProgram, clusterApiUrl, sendAndConfirmRawTransaction */
/* harmony import */ var tweetnacl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50780);
...
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54706);
/* harmony import */ var bn_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13550);
...
/* harmony import */ var bs58__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(77191);
...
/* harmony import */ var borsh__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(30022);
...
/* harmony import */ var _solana_buffer_layout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(39386);
/* harmony import */ var bigint_buffer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(40475);
/* harmony import */ var superstruct__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(53471);
/* harmony import */ var rpc_websockets__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(83937);
/* harmony import */ var jayson_lib_client_browser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(31198);
...
/* harmony import */ var secp256k1__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(17221);
...
/* harmony import */ var js_sha3__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(91094);
...
class Enum extends (/* unused pure expression or super */ null && (Struct)) {
  constructor(properties) {
    super(properties);
    this.enum = '';
...
const DEFAULT_SIGNATURE = buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer.alloc */ .lW.alloc(SIGNATURE_LENGTH_IN_BYTES).fill(0);
/**
...
const bigInt = length => property => {
  ...
  bigIntLayout.decode = (buffer, offset) => {
    ...
    return (0,bigint_buffer__WEBPACK_IMPORTED_MODULE_6__.toBigIntLE)(buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer.from */ .lW.from(src));
  };
...
var fastStableStringify$1 = (/* unused pure expression or super */ null && (fastStableStringify));
...
const BufferFromRawAccountData = (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .coerce */ .oQ)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .instance */ .eE)(buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer */ .lW), RawAccountDataResult, value => buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer.from */ .lW.from(value[0], 'base64'));
/**
 * Attempt to use a recent blockhash for up to 30 seconds
 * @internal
 */

const BLOCKHASH_CACHE_TIMEOUT_MS = (/* unused pure expression or super */ null && (30 * 1000));
/**
 * HACK.
...
const ParsedOrRawAccountData = (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .coerce */ .oQ)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .union */ .G0)([(0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .instance */ .eE)(buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer */ .lW), ParsedAccountDataResult]), (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .union */ .G0)([RawAccountDataResult, ParsedAccountDataResult]), value => {
...
const ParsedConfirmedTransactionResult = (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .type */ .dt)({
  signatures: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .array */ .IX)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .string */ .Z_)()),
  message: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .type */ .dt)({
    accountKeys: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .array */ .IX)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .type */ .dt)({
      pubkey: PublicKeyFromString,
...
const GetBlockRpcResult = jsonRpcResult((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .nullable */ .AG)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .type */ .dt)({
  ...
  rewards: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .optional */ .jt)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .array */ .IX)((0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .type */ .dt)({
    pubkey: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .string */ .Z_)(),
    lamports: (0,superstruct__WEBPACK_IMPORTED_MODULE_11__/* .number */ .Rx)(),
...
class Secp256k1Program {
  ...
  static publicKeyToEthAddress(publicKey) {
    ...
    try {
      return buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer.from */ .lW.from(js_sha3__WEBPACK_IMPORTED_MODULE_10___default().keccak_256.update(toBuffer(publicKey)).digest()).slice(-ETHEREUM_ADDRESS_BYTES);
    } catch (error) {
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    try {
      ...
      const messageHash = buffer__WEBPACK_IMPORTED_MODULE_1__/* .Buffer.from */ .lW.from(js_sha3__WEBPACK_IMPORTED_MODULE_10___default().keccak_256.update(toBuffer(message)).digest());
      const {
        signature,
        recid: recoveryId
