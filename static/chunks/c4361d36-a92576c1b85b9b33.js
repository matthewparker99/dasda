...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(37556);
/* harmony import */ var bn_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13550);
/* harmony import */ var bn_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(bn_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(71885);
...
function sendAndConfirmTransaction(title, connection, transaction, ...signers) {
  return (0,_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .sendAndConfirmTransaction */ .BV)(connection, transaction, signers, {
    skipPreflight: false
  });
}

const TOKEN_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh('TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA');
const ASSOCIATED_TOKEN_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh('ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL');
...
const NATIVE_MINT = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh('So11111111111111111111111111111111111111112');
/**
...
class Token {
  ...
  static async createMint(connection, payer, mintAuthority, freezeAuthority, decimals, programId) {
    const mintAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Keypair.generate */ .RG.generate();
    ...
    const transaction = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW();
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .SystemProgram.createAccount */ .yc.createAccount({
  ...
  async createAccount(owner) {
    ...
    const newAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Keypair.generate */ .RG.generate();
    const transaction = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW();
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .SystemProgram.createAccount */ .yc.createAccount({
  ...
  async createAssociatedTokenAccountInternal(owner, associatedAddress) {
    await sendAndConfirmTransaction('CreateAssociatedTokenAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createAssociatedTokenAccountInstruction(this.associatedProgramId, this.programId, this.publicKey, associatedAddress, owner, this.payer.publicKey)), this.payer);
  ...
  static async createWrappedNativeAccount(connection, programId, owner, payer, amount) {
    ...
    transaction.add(_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .SystemProgram.transfer */ .yc.transfer({
      fromPubkey: payer.publicKey,
  ...
  async createMultisig(m, signers) {
    const multisigAccount = _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Keypair.generate */ .RG.generate(); // Allocate memory for the account
    ...
    let keys = [{
      ...
      pubkey: _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .SYSVAR_RENT_PUBKEY */ .ze,
      isSigner: false,
      isWritable: false
    }];
  ...
  async getMintInfo() {
    ...
    if (mintInfo.mintAuthorityOption === 0) {
      ...
      mintInfo.mintAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(mintInfo.mintAuthority);
    }
    ...
    if (mintInfo.freezeAuthorityOption === 0) {
      ...
      mintInfo.freezeAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(mintInfo.freezeAuthority);
    }
  ...
  async getAccountInfo(account, commitment) {
    ...
    accountInfo.mint = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(accountInfo.mint);
    accountInfo.owner = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(accountInfo.owner);
    ...
    if (accountInfo.delegateOption === 0) {
      ...
      accountInfo.delegate = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(accountInfo.delegate);
    ...
    if (accountInfo.closeAuthorityOption === 0) {
      ...
      accountInfo.closeAuthority = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(accountInfo.closeAuthority);
    }
  ...
  async getMultisigInfo(multisig) {
    ...
    multisigInfo.signer1 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer1);
    multisigInfo.signer2 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer2);
    multisigInfo.signer3 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer3);
    multisigInfo.signer4 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer4);
    multisigInfo.signer5 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer5);
    multisigInfo.signer6 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer6);
    multisigInfo.signer7 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer7);
    multisigInfo.signer8 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer8);
    multisigInfo.signer9 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer9);
    multisigInfo.signer10 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer10);
    multisigInfo.signer11 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(multisigInfo.signer11);
    return multisigInfo;
  }
  /**
  ...
  async transfer(source, destination, owner, multiSigners, amount) {
    ...
    return await sendAndConfirmTransaction('Transfer', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createTransferInstruction(this.programId, source, destination, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
  ...
  async approve(account, delegate, owner, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('Approve', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createApproveInstruction(this.programId, account, delegate, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
  ...
  async revoke(account, owner, multiSigners) {
    ...
    await sendAndConfirmTransaction('Revoke', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createRevokeInstruction(this.programId, account, ownerPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
  ...
  async setAuthority(account, newAuthority, authorityType, currentAuthority, multiSigners) {
    ...
    await sendAndConfirmTransaction('SetAuthority', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createSetAuthorityInstruction(this.programId, account, newAuthority, authorityType, currentAuthorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Mint new tokens
   *
  ...
  async mintTo(dest, authority, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('MintTo', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createMintToInstruction(this.programId, this.publicKey, dest, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
   * Burn tokens
   *
  ...
  async burn(account, owner, multiSigners, amount) {
    ...
    await sendAndConfirmTransaction('Burn', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createBurnInstruction(this.programId, this.publicKey, account, ownerPublicKey, multiSigners, amount)), this.payer, ...signers);
  }
  /**
   * Close account
   *
  ...
  async closeAccount(account, dest, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('CloseAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createCloseAccountInstruction(this.programId, account, dest, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Freeze account
   *
  ...
  async freezeAccount(account, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('FreezeAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createFreezeAccountInstruction(this.programId, account, this.publicKey, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
   * Thaw account
   *
  ...
  async thawAccount(account, authority, multiSigners) {
    ...
    await sendAndConfirmTransaction('ThawAccount', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createThawAccountInstruction(this.programId, account, this.publicKey, authorityPublicKey, multiSigners)), this.payer, ...signers);
  }
  /**
  ...
  async transferChecked(source, destination, owner, multiSigners, amount, decimals) {
    ...
    return await sendAndConfirmTransaction('TransferChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createTransferCheckedInstruction(this.programId, source, this.publicKey, destination, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
   * Grant a third-party permission to transfer up the specified number of tokens from an account,
  ...
  async approveChecked(account, delegate, owner, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('ApproveChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createApproveCheckedInstruction(this.programId, account, this.publicKey, delegate, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async mintToChecked(dest, authority, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('MintToChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createMintToCheckedInstruction(this.programId, this.publicKey, dest, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async burnChecked(account, owner, multiSigners, amount, decimals) {
    ...
    await sendAndConfirmTransaction('BurnChecked', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createBurnCheckedInstruction(this.programId, this.publicKey, account, ownerPublicKey, multiSigners, amount, decimals)), this.payer, ...signers);
  }
  /**
  ...
  async syncNative(nativeAccount) {
    await sendAndConfirmTransaction('SyncNative', this.connection, new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .Transaction */ .YW().add(Token.createSyncNativeInstruction(this.programId, nativeAccount)), this.payer);
  }
  /**
  ...
  static createInitMintInstruction(programId, mint, decimals, mintAuthority, freezeAuthority) {
    ...
    let data = buffer.Buffer.alloc(1024);
    {
      const encodeLength = commandDataLayout.encode({
        ...
        freezeAuthority: pubkeyToBuffer(freezeAuthority || new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(0))
      }, data);
      data = data.slice(0, encodeLength);
    }
    return new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .TransactionInstruction */ .Sl({
      keys,
      programId,
      data
    });
  ...
  static createSetAuthorityInstruction(programId, account, newAuthority, authorityType, currentAuthority, multiSigners) {
    ...
    let data = buffer.Buffer.alloc(1024);
    {
      const encodeLength = commandDataLayout.encode({
        ...
        newAuthority: pubkeyToBuffer(newAuthority || new _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey */ .nh(0))
      }, data);
      data = data.slice(0, encodeLength);
    }
    let keys = [{
  ...
  static async getAssociatedTokenAddress(associatedProgramId, programId, mint, owner, allowOwnerOffCurve = false) {
    if (!allowOwnerOffCurve && !_solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey.isOnCurve */ .nh.isOnCurve(owner.toBuffer())) {
      throw new Error(`Owner cannot sign: ${owner.toString()}`);
    }

    return (await _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .PublicKey.findProgramAddress */ .nh.findProgramAddress([owner.toBuffer(), programId.toBuffer(), mint.toBuffer()], associatedProgramId))[0];
  }
  /**
  ...
  static createAssociatedTokenAccountInstruction(associatedProgramId, programId, mint, associatedAccount, owner, payer) {
    ...
    let keys = [{
      ...
      pubkey: _solana_web3_js__WEBPACK_IMPORTED_MODULE_1__/* .SystemProgram.programId */ .yc.programId,
      isSigner: false,
      isWritable: false
    }, {
      pubkey: programId,
